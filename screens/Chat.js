...
const Chat = ({navigation, route}) => {
    ...
    // Set messages state to an empty array 
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            ...
            headerRight: ()=>(
                <View style={{
                    ...
                    <TouchableOpacity>
                        <FontAwesome name="video-camera" size={24} style={{marginLeft: 10}} color="#fff"/>
                    </TouchableOpacity>
                    <TouchableOpacity>
       ...
       const sendMessage =()=>{
           Keyboard.dismiss();
           // Check to see what chat we are currently in 
           // by passing in the ID of the chat name 
            ...
            >
             ...
             <ScrollView contentContainerStyle={{paddingTop: 15}}>
                  ...
                  <View style={styles.footer}>
                    ...
                    /> 
                    <TouchableOpacity onPress={sendMessage} activeOpcacity={0.5}>
